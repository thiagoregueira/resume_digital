...
curriculum_file = current_dir / 'assets' / 'thiago_regueira_cv.pdf'
...
PROJECTS_DATA = {
    ...
    '🏅 Notebook Análise Exploratória Dataset Titanic': 'https://colab.research.google.com/drive/1Y1Fa5YKhzadU1vm4GYo3-uyD3sjaDT93',
